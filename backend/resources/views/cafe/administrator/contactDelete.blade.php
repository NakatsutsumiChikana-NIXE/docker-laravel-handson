    ...
    <body>
        ...
        <div class="contact-card">
            <div class="card">
                ...
                <form method="post" action="/cafe_administrator/contact_delete">
                    @csrf
                    <div class="card-body">
                        <div>
                            <label for="comment"><strong>削除対象コメント:</strong></label>
                            <span id="comment">{{ $businessContact }}</span>
                        </div>
                        <div>
                    ...
                    <div class="card-footer">
                        @php
                            $userAndCommentId = $userId . '_' . $commentId;
                        @endphp
                        <div class="text-right">
                            <button type="submit" class="btn btn-danger" name="userAndCommentId" value="{{ $userAndCommentId }}">削除</button>
                        </div>
                    </div>
                </form>
            </div>
